...
const api: DesktopAPI = {
  ...
  inspectModel: path => ipcRenderer.invoke('slx:inspect', { path }),
  diffModels: (oldPath, newPath, includeLayout) => ipcRenderer.invoke('slx:diff', { oldPath, newPath, includeLayout }),
