...
[中文](README.md) · [Installation](#installation) · [5-minute workflow](#the-5-minute-workflow) · [CLI](#cli-command-reference) · [M editor](#m-editor) · [SLX editor](#slx-editor) · [Desktop](#desktop-app) · [AI](#optional-ai-assistant)
...
![SLX Studio 2.0 MATLAB editor](docs/assets/slx-studio-v10-beta.png)
...
- The [v2.0.0 release](https://github.com/savellonirourou107-hue/SLX-Studio/releases/tag/v2.0.0) includes a portable Windows app, Electron installer, legacy EXE/installer, Python wheel and source archive. Windows build, install, launch, reopen and uninstall smoke checks passed in GitHub Actions.
...
- [`src/slxdiff`](src/slxdiff): Python core, CLI, SLX parsing/diff/review, MATLAB bridge and legacy Workbench.
- [`apps/desktop`](apps/desktop): the 2.0 Electron/TypeScript/Monaco desktop.
- [`extensions`](extensions): trusted first-party and sample extensions.
- [`tests`](tests): Python, protocol, MATLAB integration and regression tests.
- [`docs`](docs): architecture, migration, compatibility, maintenance and usage notes.

New users should start with [Installation](#installation) and [The 5-minute workflow](#the-5-minute-workflow), then consult [`docs/studio.md`](docs/studio.md) or [`docs/architecture.md`](docs/architecture.md) as needed.
