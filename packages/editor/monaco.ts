...
import { registerMatlabIntelligence } from './matlab-intelligence';
...
// Tokenizer plus offline lexical assistance, not MATLAB language-server semantics.
...
export const matlabIntelligence = registerMatlabIntelligence(monaco);
export { monaco };
